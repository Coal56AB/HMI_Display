...
Для загрузки из Keil откройте созданный `.build/Keil/BluePillHMI.uvprojx`.
Исходный проект содержит пустой модуль; BUILD его не изменяет.
Автоматическая сборка устройство не прошивает.
